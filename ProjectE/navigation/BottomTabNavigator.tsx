...
import HomeButtonTipSvg from "../assets/discard/HomeButtonTipSvg.js";
...
function BottomTabNavigator() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (newSkipRef == "true") {
        ...
        await AsyncStorage.setItem("newSkipRef", "true").catch((error) =>
          console.log(error)
        );
      }
    }
  ...
  const Icon = (props: {
    ...
    return (
      <>
        <FontAwesome name="confluence" color={props.color} />
      </>
      // <>
  ...
  return (
    ...
    >
      <BottomTab.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => <FontAwesome name="users" color={color} />,
          tabBarButton: (props) => {
            return <Pressable {...props} onPress={checkAuth} />;
          },
        }}
      />
      ...
      <BottomTab.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => <FontAwesome name="store" color={color} />,
        }}
      />
    </BottomTab.Navigator>
  );

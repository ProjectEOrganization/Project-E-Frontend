...
function Icon() {
  ...
  return (
    <View style={{backgroundColor: 'transparent', alignItems: 'center', marginBottom: 0}}>
     
      <HomeButtonTipSvg />
      

    <TouchableOpacity onPress={onPress} style={{ marginBottom: 50, backgroundColor: 'transparent', height: 0 }}>
      <SvgComponentNav />
    </TouchableOpacity>
    </View>
  );

  ...
  return (
    <View style={styles.overallContainer}>
      ...
      <View style={{ width: 260, paddingTop: 30, alignItems: "center" }}>
        <Text style={styles.firstText}>Friend Request Sent!</Text>

        {/* PROBABLY NEED AN IF STATEMENT (like if on certain page, display different text below) */}
        <Text style={styles.secondText}>
          Once they accept your friend request, you can chat with them in the
          friends tab by swiping left
        </Text>
        ...
        >
          <Text style={styles.loginText}>Sweet!</Text>
        </TouchableOpacity>
      </View>

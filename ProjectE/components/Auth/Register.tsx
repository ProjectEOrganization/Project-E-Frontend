...
<TouchableOpacity style={styles.loginButton}>
        ...
        <Text style={{fontSize: 10, color: '#A9ACB0', marginTop: 40, fontFamily: 'Inter-Medium'}}>By signing up, you agree to our Terms of Service and acknowledge that you read our Privacy Policy</Text>
        
        <Text style={{fontSize: 15, color: '#A9ACB0', marginTop: 25, marginLeft: 15 , fontFamily: 'Inter-Medium'}}>Already have an account? <Text style={{color:'#4B00FF', fontFamily: 'Inter-SemiBold'}}>Log in</Text></Text> 
